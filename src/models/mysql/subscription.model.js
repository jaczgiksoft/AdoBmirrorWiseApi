...
const Subscription = sequelize.define('Subscription', {
    ...
    // 📊 Índices documentados (no crean nada, solo informan al ORM)
    indexes: [
        { fields: ['tenant_id'], name: 'idx_subscriptions_tenant' },
        { fields: ['status'], name: 'idx_subscriptions_status' },
        { fields: ['end_date'], name: 'idx_subscriptions_end_date' },
        { fields: ['plan_name'], name: 'idx_subscriptions_plan_name' }
    ]
});
