...
const PatientProfession = sequelize.define('PatientProfession', {
    ...
    indexes: [
        { fields: ['tenant_id'], name: 'idx_patient_professions_tenant' },
        { fields: ['name'], name: 'idx_patient_professions_name' },
        { fields: ['abbreviation'], name: 'idx_patient_professions_abbreviation' },
        {
            unique: true,
